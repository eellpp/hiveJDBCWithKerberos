...
public class HiveJDBC {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Connection con = DriverManager.getConnection("jdbc:hive2://quickstart.cloudera" +
                ":10000/default;principal=hive/quickstart.cloudera@CLOUDERA");
